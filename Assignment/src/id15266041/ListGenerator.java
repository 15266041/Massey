...
public class ListGenerator {
	...
	public void Run(String filename) throws Exception
	{
		...
		int count = 0;//remove
		for(ArrayList<String> line : data) //remove
		{
			System.out.println(line);
			count++;
		}
	...
	private ArrayList<ArrayList<String>> FilterData(ArrayList<ArrayList<String>> data, ArrayList<ArrayList<String>> filter)
	{
		for (ArrayList<String> point : filter)
		{
			data.remove(point);
		}
		return data;
